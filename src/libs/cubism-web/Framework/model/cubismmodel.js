...
export class CubismModel {
    ...
    _isOverwrittenModelMultiplyColors; // SDK上でモデル全体の乗算色を上書きするか判定するフラグ
    _isOverwrittenModelScreenColors; // SDK上でモデル全体のスクリーン色を上書きするか判定するフラグ
    _userMultiplyColors; // Drawableごとに設定する乗算色と上書きフラグを管理するリスト
    _userScreenColors; // Drawableごとに設定するスクリーン色と上書きフラグを管理するリスト
    _userPartScreenColors; // Part 乗算色の配列
    ...
    _modelOpacity; // モデルの不透明度
    _parameterIds;
    _partIds;
    _drawableIds;
    _isOverwrittenCullings; // モデルのカリング設定をすべて上書きするか？
    _userCullings; // カリング設定の配列
}
